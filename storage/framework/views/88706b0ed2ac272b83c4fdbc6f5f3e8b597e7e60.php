...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="ml-4 text-lg leading-7 font- semibold"><h1 class="text-gray-900 dark:text-white"> Ananda Ayu Sekar </h1></div>
        <div>
    </body>
</html>
...
<?php /**PATH C:\xampp2\htdocs\cms\resources\views/welcome.blade.php ENDPATH**/ ?>